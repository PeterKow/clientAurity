...
export const twitterResultsSimple = [
  {
    ...
    author: 'Irfan',
    text: 'RT @VersatileStaff: #versatilestaff #frontendDeveloper #London #javaScript #ember ' +
    '#reactjs #angularjs Frontend Developer required for L…htt…',
    completed: true,
  },
  {
    id: 1,
    ...
    text: 'RT @LondonNewsUK: JavaScript Developer AngularJS - Start-up http://t.co/mg84kIifFx ' +
    '#London #UK #News',
    completed: false,
  ...
  },
  {
    ...
    text: 'RT @23business: #startup #jobs : JavaScript Developer AngularJS - Start-up: ' +
    'London-London, JavaScript Developer / Programmer (... http://t.…',
    completed: false,
  },
];
